<div class="form-group row">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            {!! Form::select('periodo_id_id',$periodos, null, ['class' => 'form-control mb-3','placeholder'=>'Seleccione un Periodo', 'id'=>'periodo_id','required']) !!}
        </div>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-lg-4">
        <div class="form-group">
            {!! Form::select('indicador',['bajo' => 'Bajo','basico' => 'Basico','alto' => 'Alto','superior' => 'Superior'], null, ['class' => 'form-control mb-3','placeholder'=>'Seleccione un Desempeño', 'id'=>'grado_id','required']) !!}
        </div>
    </div>
</div>
<div class="form-group row">
