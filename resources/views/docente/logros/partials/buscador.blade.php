{!! Form::open(['route' => 'docente.logros.findnotes', 'method' => 'post', 'class' => 'form-horizontal', 'validate' => "novalidate" ,"id"=>"form-busqueda" ]) !!}
<div id="URL-LOAD" data-user="{{currentPerfil()}}" data-urlload = "{{route('docente.logros.loaddata',1)}}" style="display: none"></div>
<div class="row">
    <div class="col-lg-3">
    ...
    <div class="col-sm-2">
        <div class="mb-3">
            <a  href="{{route('docente.logros.create')}}" class="btn btn-success ">Agregar logro <i class="fas fa-plus"></i></a>
        </div>
    </div>
</div>
{!! Form::close() !!}
