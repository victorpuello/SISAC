<div id="modalAdd" class="modal-block modal-header-color modal-block-primary modal-block-sm mfp-hide">
    <section class="card">
        ...
        <?php echo Form::open(['route' => ['notas.actualizar',':NOTA_ID'], 'method' => 'post','class' => 'form-horizontal form-bordered', 'validate'=>"novalidate",'id' => 'form-edit']); ?>
            ...
            <div class="modal-wrapper p-0">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <?php echo Form::hidden('logro_id',null,['id'=>'logro_id']); ?>

                        <?php echo Form::hidden('grado',$grado,['id'=>'grado']); ?>
                        ...
                        <?php echo Form::hidden('category',null,['id'=>'category']); ?>

                        <?php echo Form::label('score', 'Nota Cognitiva',['id'=>'label-score','class'=>'control-label text-lg-right pt-2']); ?>

                        <?php echo Form::number('score', null, ['class' => 'form-control','autofocus', 'required', 'min'=> 1, 'step'=>'.01']); ?>
