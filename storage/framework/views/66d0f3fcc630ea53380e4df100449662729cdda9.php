...
<div class="form-group row">
    ...
    <div class="col-sm-4 pl-1 pr-1">
        <?php echo Form::select('docente_id',$docentes, null, ['class' => 'form-control mb-3 pl-1', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un docente']); ?>

    </div>
    <label class="col-sm-2 control-label text-sm-right" for="w1-username">Grupo: </label>
    <div class="col-sm-4 pl-1">
        <?php echo Form::select('grupo_id',$grupos, null, ['class' => 'form-control mb-3 pl-1', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un grupo']); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-3">
        <?php echo Form::number('horas', null, ['class' => 'form-control', 'required', 'min'=> 1, 'max'=>6]); ?>

    </div>
    <label class="col-sm-1 control-label text-sm-right pl-1 pt-1" for="w1-username">Año: </label>
    <div class="col-sm-5">
        <?php echo Form::select('anio_id',$anios, null, [ 'class' => 'form-control mb-3', 'id'=>'anio','required', 'placeholder'=>'Seleccione una año']); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <div class="radio-custom radio-primary">
            <?php echo Form::radios('director', ['0' => 'No', '1' => 'Si'],null,['classes' => 'pl-0 form-control mb-3','id'=>'director']); ?>

        </div>
    </div>
</div>
<?php echo Form::hidden('active',true); ?><?php /**PATH C:\xampp\htdocs\SISAC\resources\views/admin/asignaciones/partials/fields.blade.php ENDPATH**/ ?>