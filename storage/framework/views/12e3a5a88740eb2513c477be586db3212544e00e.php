        ...
        <div class="col-lg-10 col-xl-10">
            <section class="card card-featured card-featured-info mb-4">
                ...
                <?php echo Form::model($user,['route'=>['user.update',$user],'method' => 'PUT','class' => 'form-horizontal form-bordered', 'files' =>true ,'id'=>'form-edit']); ?>
                    ...
                    <div class="card-body">
                        <?php echo $__env->make('users.partials.fields', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
            ...
            <section class="card card-featured card-featured-info mb-4">
                ...
                <div class="card-body">
                    <?php echo $__env->make('users.partials.partials-docente', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
            </section>
            <?php endif; ?>
        </div>
