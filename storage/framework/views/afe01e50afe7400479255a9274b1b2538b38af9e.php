<div id="modalHeaderColorPrimary" class="modal-block modal-header-color modal-block-primary ">
    <section class="card">
        ...
        <div class="card-body">
            <?php echo $__env->make('admin.planillas.partials.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\SISAC\resources\views/admin/planillas/ajax/filtro.blade.php ENDPATH**/ ?>