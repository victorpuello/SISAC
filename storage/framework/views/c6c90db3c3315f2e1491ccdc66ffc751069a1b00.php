<?php $__env->startSection('titulo', "Error"); ?>
<?php $__env->startSection('namePage', "Error"); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <ul class="nav nav-list flex-column primary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(route('logros.index')); ?>"><i class="fas fa-caret-right text-dark"></i> Ir a: Logros</a>
                    </li>
                </ul>
            </div>
        </div>
