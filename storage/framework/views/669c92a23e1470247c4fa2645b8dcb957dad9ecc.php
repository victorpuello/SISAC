...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo Form::select('docente_id',$docentes, null, ['class' => 'form-control mb-3', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un docente']); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo Form::select('salon_id',$salones, null, ['class' => 'form-control mb-3', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un grupo']); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <div class="radio-custom radio-primary">
            <?php echo Form::radios('director', ['0' => 'No', '1' => 'Si']); ?>
