        ...
        <?php $__currentLoopData = $docentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3">
                <section class="card">
                    ...
                    <div class="card-body">
                        <h4 class="font-weight-semibold mt-3"><?php echo e($docente->user->name); ?></h4>
                        <p><strong>Asignaturas: </strong><?php echo e($docente->getNameAsignaturasAttibute()); ?></p>
                        <hr class="solid short">
                        <div class="row">
                            <div class="col-lg-6">
                                <p class="mb-1"><a href="<?php echo e(route('docentes.edit',$docente->id)); ?>"><i class="fas fa-user-edit mr-1"></i>Editar</a></p>
                                <p class="mb-1"><a href="#modalEliminar" class="deleted modal-basic" data-nuser="<?php echo e($docente->user->FullName); ?>" data-url="<?php echo e(route('docentes.destroy', $docente->id )); ?>"><i class="fas fa-trash-alt mr-1"></i> Eliminar</a></p>
