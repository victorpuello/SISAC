                            ...
                            <div class="widget-summary-col mt-3">
                                ...
                                <div class="summary-footer">
                                    <?php if (\Illuminate\Support\Facades\Blade::check('director')): ?>
                                        <a href="<?php echo e(route('docente.direccion.index')); ?>" class="text-muted text-uppercase">(Ver Todos)</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col  mt-3">
                                <div class="summary" style="min-height: 48px;">
                                    ...
                                    <div class="info">
                                        <strong class="timer amount count-title count-number" data-to="<?php echo e($Nasignaciones); ?>" data-speed="3500"></strong>
                                    </div>
                                </div>
                                <div class="summary-footer">
                                    <a href="<?php echo e(route('docente.asignaciones.index')); ?>" class="text-muted text-uppercase">(Ver Todas)</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col mt-3">
                                ...
                                <div class="summary-footer">
                                    <a class="text-muted text-uppercase" href="<?php echo e(route('docente.logros.index')); ?>">(Ver Todos)</a>
                                </div>
                            </div>
                        </div>
                    </div>
