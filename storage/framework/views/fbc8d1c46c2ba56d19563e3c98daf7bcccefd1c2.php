...
<?php $__env->startSection('content'); ?>
    <section class="card card-featured card-featured-primary mb-4">
        ...
        <div class="card-body">
            ...
            <?php echo Form::model($estudiante,['route' => ['docente.estudiantes.update',$estudiante], 'method' => 'PUT','files' => true,'class' => 'form-horizontal form-bordered']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <?php echo Form::number('identification',null,['class' => 'form-control','id'=>'identification', 'placeholder' => 'Por favor introduzca N° Identificación']); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-4">
                    ...
                    <?php echo Form::select('birthcity', $municipios,null,['class' => 'form-control mb-3', 'id'=>'birthcity','required']); ?>
