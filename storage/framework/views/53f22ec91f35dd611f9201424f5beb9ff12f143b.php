                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-auto col-lg-auto col-sm-auto ml-auto ml-lg-auto mr-auto mr-lg-auto">
                                    <a href="<?php echo e(Route('docente.planillas.show',$planilla)); ?>" class="btn btn-lg btn-info center" ><i class="fas fa-pencil-alt mr-1"></i>Calificar</a>
                                </div>
                            </div>
                            <?php echo Form::model($planilla,['route' => ['docente.planillas.update',$planilla], 'method' => 'PUT','class' => 'form-horizontal form-bordered']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SISAC\resources\views/docente/planillas/index.blade.php ENDPATH**/ ?>