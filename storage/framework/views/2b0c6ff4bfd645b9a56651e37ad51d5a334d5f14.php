...
<?php $__env->startSection('content'); ?>
    <section class="card card-featured card-featured-primary mb-4">
        ...
        <div class="card-body">
            <?php echo $__env->make('admin.acudientes.partials.messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            <?php echo Form::open(['route' => 'acudiente.store', 'method' => 'post','files' => true,'class' => 'form-horizontal form-bordered']); ?>
