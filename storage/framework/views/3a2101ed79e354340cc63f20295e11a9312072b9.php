                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col  mt-3">
                                <div class="summary" style="min-height: 48px;">
                                    ...
                                    <div class="info">
                                        <strong class="timer amount count-title count-number" data-to="<?php echo e($asignaciones); ?>" data-speed="3500"></strong>
                                    </div>
                                </div>
                                <div class="summary-footer">
                        ...
                        <div class="widget-summary">
                            ...
                            <div class="widget-summary-col mt-3">
                                <div class="summary" style="min-height: 48px;">
                                    ...
                                    <div class="info">
                                        <strong class="timer amount count-title count-number" data-to="<?php echo e($indicadores); ?>" data-speed="3500"></strong>
                                    </div>
                                </div>
                                <div class="summary-footer">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SISAC\resources\views/docente/home.blade.php ENDPATH**/ ?>