...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo Form::select('estado',['activo'=>'Activo','inactivo'=>'Inactivo','finalizado'=>'Finalizado',], null, ['class' => 'form-control mb-3', 'id'=>'estado','required', 'placeholder'=>'Seleccione un estado']); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <div class="radio-custom radio-primary">
            <?php echo Form::radios('isFinal', ['0' => 'No', '1' => 'Si'],null,['class' => 'pl-0 form-control mb-3','id'=>'isFinal']); ?>
...
<?php /**PATH C:\xampp\htdocs\SISAC\resources\views/admin/periodos/partials/fields.blade.php ENDPATH**/ ?>