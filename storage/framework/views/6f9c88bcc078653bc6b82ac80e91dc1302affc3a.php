<div class="tab-content">
    <div id="w1-account" class="tab-pane p-3 active">
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <?php echo Form::select('user_id',array_pluck($users,'name','id'), null, ['class' => 'form-control mb-3', 'id'=>'w1-username','required', 'placeholder'=>'Seleccione un docente']); ?>
        ...
        <div class="form-group row">
            <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <?php echo Form::select('coordinator',['0'=>'No','1' => 'Si'], null, ['class' => 'form-control mb-3', 'id'=>'coordinator','required']); ?>
