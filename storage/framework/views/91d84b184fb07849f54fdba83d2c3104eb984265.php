...
<?php $__env->startSection('namePage', "Modulo: Alummnos - Crear "); ?>
...
<?php $__env->startSection('content'); ?>
    <section class="card card-featured card-featured-primary mb-4">
        ...
        <div class="card-body">
            ...
            <?php echo Form::open(['route' => 'estudiantes.store', 'method' => 'post','files' => true,'class' => 'form-horizontal form-bordered']); ?>
