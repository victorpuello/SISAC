                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <?php $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <p class="mb-1"><a href="<?php echo e(route('docente.notas.getplanilla',['planilla'=>$asignacion,'periodo'=>$periodo])); ?>" class="edit"><i class="fas fa-check mr-1"></i><?php echo e($periodo->name); ?></a></p>
