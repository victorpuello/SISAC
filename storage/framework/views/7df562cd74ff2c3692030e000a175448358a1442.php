                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <p class="mb-1"><a href="<?php echo e(route('docente.notas.loadplanilla',['Idsalon'=>$planilla->id,'Iddocente'=>$planilla->idDocente,'Idasignatura'=>$planilla->idAsignaturas,'Idperiodo'=>$periodo->id])); ?>" class="edit"><i class="fas fa-check mr-1"></i><?php echo e($periodo->name); ?></a></p>
