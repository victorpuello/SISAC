...
<?php $__env->startSection('content'); ?>
    <div class="row">
                ...
                <section class="card">
                    <header class="card-header bg-<?php echo e(Config::get('institucion.fondos.2')); ?>">
                        <div class="card-header-profile-picture">
                            <img src="<?php echo e(asset("storage/usersdata/img/estudiantes/".$estudiante->path)); ?>">
                        </div>
                    </header>
                    <div class="card-body">
        ...
        <?php echo $__env->make('docente.direccion-de-grupo.partials.modals', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
<?php $__env->stopSection(); ?>
