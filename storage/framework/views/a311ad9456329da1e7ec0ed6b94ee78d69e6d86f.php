<div id="modalHeaderColorPrimary" class="modal-block modal-header-color modal-block-primary ">
    <section class="card">
        <?php echo Form::open(['route' => 'asignaturas.store', 'method' => 'POST','class' => 'form-horizontal form-bordered']); ?>
...
</div><?php /**PATH /var/www/SISAC/resources/views/admin/asignaturas/ajax/create.blade.php ENDPATH**/ ?>