        ...
        <div class="card-body">
            <div class="modal-wrapper">
                ...
                <div class="modal-text">
                    <p>Estas seguro que deseas eliminar el indicador para: <strong id="Nombreasg"></strong></p>
                </div>
            </div>
        </div>
...
<!-- End Modal Eliminar-->
<?php /**PATH C:\xampp\htdocs\SISAC\resources\views/admin/suggestions/partials/modals.blade.php ENDPATH**/ ?>