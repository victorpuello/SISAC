<div id="modalHeaderColorPrimary" class="modal-block modal-header-color modal-block-primary ">
    <section class="card">
        <?php echo Form::open(['route' => 'suggestions.process', 'method' => 'POST','files' => true,'class' => 'form-horizontal form-bordered','novalidate' => "novalidate"]); ?>
...
</div><?php /**PATH C:\xampp\htdocs\SISAC\resources\views/admin/suggestions/ajax/import.blade.php ENDPATH**/ ?>